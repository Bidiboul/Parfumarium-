...
export const metadata: Metadata = {
  title: "Mon compte — Connexion sécurisée",
  description:
    "Connectez-vous à votre espace Parfumarium pour suivre vos commandes, gérer vos informations et vos adresses, en toute sécurité.",
};

const FEATURES = [
  {
    title: "Vos commandes",
    text: "Retrouvez l'historique de toutes vos commandes et leur suivi.",
    icon: (
      <path
  ...
  },
  {
    ...
    text: "Adresse e-mail, mot de passe, numéro de téléphone : modifiables à tout moment.",
    icon: (
      <>
  ...
  {
    title: "Vos adresses",
    text: "Enregistrez vos adresses de livraison pour commander plus vite.",
    icon: (
      <>
  ...
  return (
    <>
      <PageHero
        ...
        title="Mon compte Parfumarium"
        subtitle="Suivez vos commandes et gérez vos informations en toute sécurité."
      />
          ...
          <FadeIn className="lg:col-span-5">
            <div className="rounded-2xl border border-champagne bg-cream p-8 md:p-10">
              ...
              <p className="mt-3 font-sans text-sm leading-relaxed text-warmgray">
                Votre espace est protégé et géré par Shopify. Connectez-vous ou
                créez un compte en quelques secondes.
              </p>

              <div className="mt-8 flex flex-col gap-3">
                <a href={loginUrl} className="btn-primary w-full">
                  Se connecter
                </a>
                <a href={registerUrl} className="btn-outline w-full">
                  Créer un compte
                </a>
              </div>
              ...
              <p className="mt-6 flex items-center gap-2 font-sans text-xs text-warmgray">
                ...
                Connexion chiffrée · Vos données ne sont jamais stockées sur ce site.
              </p>
            </div>
          ...
          <FadeIn delay={120} className="lg:col-span-7">
            ...
            <div className="mt-8 space-y-4">
              {FEATURES.map((f) => (
                <div
                  key={f.title}
                  className="flex gap-5 rounded-2xl border border-champagne bg-white p-6"
                >
                  ...
                  <div>
                    ...
                    <p className="mt-1 font-sans text-sm leading-relaxed text-warmgray">
                      {f.text}
                    </p>
                  </div>
                </div>
