...
export default function Hero() {
  const featured = getProductBySlug("ambre-royal");
    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-sand via-ivory to-ivory pt-[88px]">
      ...
      <div className="container-luxe relative grid items-center gap-10 py-16 md:grid-cols-2 md:gap-8 md:py-24 lg:py-28">
        ...
        <div className="max-w-xl animate-fade-up">
          <span className="eyebrow">Maison de parfums · Depuis 2024</span>
          ...
          <p className="mt-6 max-w-md font-sans text-base leading-relaxed text-warmgray md:text-lg">
            Découvrez des fragrances raffinées, pensées pour sublimer chaque
            instant. Un luxe discret, conçu pour le quotidien.
          </p>
        ...
        <div className="relative flex justify-center md:justify-end">
          <div className="relative w-full max-w-sm animate-fade-in">
            ...
            <div className="animate-slow-float overflow-hidden rounded-[2rem] border border-white/60 bg-white/40 shadow-card backdrop-blur-sm">
              {featured && (
                <BottleVisual
            ...
            <div className="absolute -bottom-5 -left-5 rounded-2xl border border-ink/8 bg-ivory px-5 py-4 shadow-soft">
              ...
              <p className="mt-1 font-serif text-lg text-ink">Ambre Royal</p>
              <p className="font-sans text-sm text-amber">39,90 €</p>
            </div>
          </div>
        </div>
      </div>
