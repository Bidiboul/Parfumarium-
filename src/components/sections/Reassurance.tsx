const ITEMS = [
  {
    title: "Expédition en 72h",
    text: "Préparée avec soin et expédiée rapidement.",
    icon: (
      <>
  ...
  },
  {
    ...
    text: "Transactions protégées et chiffrées.",
    icon: (
      <>
  ...
  },
  {
    ...
    text: "Choisis pour leur tenue et leur caractère.",
    icon: (
  ...
  {
    title: "Conseil & boutique",
    text: "Une équipe disponible, à Vaison-la-Romaine.",
    icon: (
      <>
  ...
  return (
    <section className="border-b border-champagne bg-white">
      <div className="container-luxe grid grid-cols-2 gap-x-6 gap-y-8 py-10 md:grid-cols-4 md:py-8">
        {ITEMS.map((item) => (
          <div key={item.title} className="flex flex-col items-center gap-3 text-center md:flex-row md:gap-4 md:text-left">
